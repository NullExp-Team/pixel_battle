        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: switch (_style) {
              _Style.fill => colors.white,
              _Style.outline || _Style.text => colors.primary100,
            },
            disabledForegroundColor: switch (_style) {
              _Style.fill => colors.white,
              _Style.outline || _Style.text => colors.grey101,
            },
            backgroundColor: switch (_style) {
              _Style.fill => colors.primary100,
              _Style.outline || _Style.text => Colors.transparent,
            },
            disabledBackgroundColor: switch (_style) {
              _Style.fill => colors.grey101,
              _Style.outline || _Style.text => Colors.transparent,
            },
            ...
            shape: RoundedRectangleBorder(
              ...
              side: switch (_style) {
                _Style.outline => BorderSide(color: colors.primary100),
            ...
            child: (isLoadingState.value && showLoading) || isLoading
                ? SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      ...
                      color: switch (_style) {
                        _Style.fill => colors.white,
                        _Style.outline || _Style.text => Colors.black,
                      },
                    ),
                  )
                : Row(
