...
abstract class $LoginDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String nickname, @JsonKey(name: 'user_id') String? userId});
}
...
class _$LoginDataImpl implements _LoginData {
  _$LoginDataImpl(
      {required this.nickname, @JsonKey(name: 'user_id') this.userId});
  ...
  @override
  String toString() {
    return 'LoginData(nickname: $nickname, userId: $userId)';
  }
...
abstract class _LoginData implements LoginData {
  factory _LoginData(
      ...
      @JsonKey(name: 'user_id') final String? userId}) = _$LoginDataImpl;
